    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="mt-16 bg-slate-50 rounded-3xl p-8 sm:p-10 text-center max-w-3xl mx-auto">
        ...
        <p className="text-ink-600 mt-2">
          Groups of 5 or more get 15% off any pass tier. Email <span className="text-brand-700 font-medium">groups@nexuscon.com</span> with your team size and we'll send a custom invoice.
        </p>
      </div>
    </div>
  );
